...
function CheckAuthentication()
{
	...
	if (isset($_SESSION)){  
	    ...
	    //error_log('The session has not been started.');
	}
...
ATTENTION: The trailing slash is required.
*/
$baseDir = dirname(dirname(dirname(__FILE__))).'/userfiles/';
...
*/
$config['HideFolders'] = Array(".svn", "CVS", "_thumb490");
