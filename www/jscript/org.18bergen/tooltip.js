/*
 Based on http://developer.yahoo.com/yui/3/examples/widget/widget-tooltip.html
*/
...
YUI.add("tooltip", function(Y) {
	...
	// Create a new class, Tooltip, which extends Widget, and mixes in both the WidgetPosition and WidgetStack 
	// extensions
...
}, "3.2.0", {requires:["event-mouseenter", "widget", "widget-position", "widget-stack"]});
// END WRAPPER