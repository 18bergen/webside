...
YAHOO.extend(BG18.datePicker, BG18.base, {
        
    _className: "BG18.datePicker",
    ...
    _oButton: null, 		// Button instance
    _oCalendarMenu: null,  	// Calendar menu instance
    _oCalendar: null,		// Calendar instance
    ...
    */
    onSelectDate: function(nDay,nMonth,nYear) {
    ...
    /*
    	...
    	Public function
    */
    setDate: function(nDay,nMonth,nYear) {
	...
	_onSelectDate: function (p_sType, p_aArgs) {
	...
	focusDay: function (p_sType, p_aArgs) {
	...
	createCalendarOnDemand: function () {
